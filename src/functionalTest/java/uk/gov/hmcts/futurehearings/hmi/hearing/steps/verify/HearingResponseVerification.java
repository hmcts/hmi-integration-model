package uk.gov.hmcts.futurehearings.hmi.hearing.steps.verify;
...
public class HearingResponseVerification {
    ...
    public static void verifyHearingResponse (Response response) {
        ...
        //Option 2 - Use a Json Equality based library like JsonAssert
        TestingUtils.comparePayloads("uk/gov/hmcts/futurehearings/hmi/hearing/output/mock-demo-response.json",
                            response);
