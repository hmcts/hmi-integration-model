package uk.gov.hmcts.futurehearings.hmi.integration.junit5.verify;
...
public class HearingResponseVerification {
    ...
    public static void verifyHearingResponse (Response response) {
        ...
        //Option 2 - Use a Json Equality based library like JsonAssert
        TestingUtils.comparePayloads("uk/gov/hmcts/futurehearings/hmi/integration/hearing/input/azure-mock-reponse.json",
                            response);
